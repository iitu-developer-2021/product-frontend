  ...
  <div class="products">
    <div class="products__body">
      ...
      <el-table :data="paginateProduct(filteredProducts)" height="500" empty-text="Таблица пустая">
        ...
        <el-table-column prop="barcode" label="Штрих код" width="130" />
        <el-table-column prop="name" label="Название товара" width="400" />
        <el-table-column prop="price" label="Цена" />
        <el-table-column prop="wholesalePrice" label="Опт. цена" />
        <el-table-column prop="retailPrice" label="Роз. цена" />
